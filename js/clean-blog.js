            ...
            function() {
                ...
                if (currentTop < this.previousTop) {
                    ...
                    if (currentTop > 0 && $('.navbar-custom').hasClass('is-fixed')) {
                        $('.navbar-custom, div.logo').addClass('is-visible');
                        $('#mikenav').css('top','62px');
                    } else {
                        $('.navbar-custom, div.logo').removeClass('is-visible is-fixed');
                        $('#mikenav').css('top','')
                    }
                } else {
                    //if scrolling down...
                    $('.navbar-custom').removeClass('is-visible');$('#mikenav').removeClass('showit').css('top','');
